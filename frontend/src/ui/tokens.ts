...
export const ui = {
  ...
  viewerCenter: 'flex-1 flex min-h-0 items-center justify-center overflow-hidden',
  sidebar: 'w-80 border-l border-slate-800 bg-slate-950 flex flex-col h-full',
  pageDataSidebar: 'w-80 border-l border-slate-800 bg-slate-900/70 flex flex-col overflow-hidden',
  ...
  panelList: 'flex-1 overflow-y-auto text-xs text-slate-300 space-y-2 pb-6',
  ...
  select:
    'min-w-0 flex-1 truncate bg-slate-900 border border-slate-700 text-xs px-2 py-1 rounded-md',
  selectCompact:
    'flex-1 min-w-0 bg-slate-900 border border-slate-700 text-xs px-1 py-1 rounded-md text-slate-100',
  input: 'w-full rounded-md border border-slate-700 bg-slate-950 px-2 py-1 text-sm text-slate-100',
  textarea:
  ...
  modalPanel: 'w-full max-w-sm rounded-lg border border-slate-700 bg-slate-900 p-4 shadow-xl',
  ...
  canvasNavBase: 'w-16 flex items-center justify-center select-none text-3xl font-semibold',
  ...
  topNavSegment: 'inline-flex rounded-lg border border-slate-800 bg-slate-900/70 p-1',
  topNavSegmentButton: 'px-3 py-1 text-xs font-medium rounded-md transition',
  topNavSegmentActive: 'bg-slate-200 text-slate-900',
  topNavSegmentInactive: 'text-slate-300 hover:bg-slate-800/70',
  jobsPanel: 'w-72 border-r border-slate-800 bg-slate-900/70 flex flex-col',
  ...
  trainingTabs: 'flex flex-wrap gap-2 rounded-lg border border-slate-800 bg-slate-900/60 p-2',
  trainingTab: 'rounded-md px-3 py-2 text-sm font-semibold transition',
  ...
  trainingSectionCompact: 'rounded-lg border border-slate-800 bg-slate-900/70 p-3',
  ...
  trainingSubTitle: 'text-xs font-semibold text-slate-200 uppercase tracking-wide',
  ...
  trainingLogLine: 'text-[11px] text-slate-200 font-mono whitespace-pre-wrap',
  ...
  trainingCard: 'rounded-md border border-slate-800 bg-slate-950/60 p-3',
  trainingCardCompact: 'rounded-md border border-slate-800 bg-slate-950/60 p-2',
  trainingTag:
  ...
  trainingLogBox: 'h-56 rounded-md border border-slate-800 bg-slate-950/60 overflow-auto',
  button: {
    actionIndigo:
    ...
    insertBase: 'rounded-md border border-slate-700 px-2 py-1 text-[11px]',
    insertEnabled: 'bg-slate-800 text-slate-200 hover:bg-slate-700',
    insertDisabled: 'opacity-40 cursor-not-allowed bg-slate-900 text-slate-500',
    cancel:
      'rounded-md border border-slate-700 px-2 py-1 text-[11px] text-slate-200 hover:bg-slate-800',
    deleteBase: 'rounded-md border border-red-900 px-2 py-1 text-[11px]',
    deleteEnabled: 'bg-red-900/70 text-red-100 hover:bg-red-900',
    deleteDisabled: 'opacity-40 cursor-not-allowed bg-slate-900 text-slate-500 border-slate-700',
    icon: 'w-7 h-7 flex items-center justify-center rounded-md text-xs border border-slate-700 bg-slate-800 hover:bg-slate-700',
