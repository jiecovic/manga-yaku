    ...
    <div className={ui.trainingCard}>
      ...
      <div className="mt-3 space-y-3">
        <div className={ui.trainingHelp}>
          These settings affect the queued `page_translation` workflow, not the interactive chat
          agent.
        </div>
        ...
        <div className={`${ui.trainingHelp} ml-28`}>
          Model used by the page translation workflow. Manual single-box translate uses the sidebar
          Translation profile.
        </div>
        ...
        <Field label="Detection" layout="row" labelClassName={ui.label}>
          <Select
            ...
            onChange={(e) => onUpdateDraft('page_translation.detection_profile_id', e.target.value)}
        ...
        <div className={`${ui.trainingHelp} ml-28`}>
          Optional override for page translation detection. Leave empty to use the sidebar
          selection.
        </div>
        {!pageTranslationDetectionLoading && !hasPageTranslationDetectionOptions && (
          <div className={ui.trainingHelp}>
            No text detection models available. Train a model to enable page translation detection.
          </div>
        )}
        ...
        <Field label="Reasoning" layout="row" labelClassName={ui.label}>
          <Select
            ...
            onChange={(e) => onUpdatePageTranslationDraft('reasoning_effort', e.target.value)}
          >
          ...
          <div className="flex flex-col gap-1 text-xs text-slate-300">
            ...
            <label className="inline-flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  onUpdateDraft('page_translation.include_prior_context_summary', e.target.checked)
                }
              />
            ...
            <label className="inline-flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  onUpdateDraft('page_translation.include_prior_characters', e.target.checked)
                }
              />
            ...
            <label className="inline-flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  onUpdateDraft('page_translation.include_prior_open_threads', e.target.checked)
                }
              />
            ...
            <label className="inline-flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  onUpdateDraft('page_translation.include_prior_glossary', e.target.checked)
                }
              />
              include glossary
            </label>
        ...
        <div className={`${ui.trainingHelp} ml-28`}>
          Controls which saved volume memory blocks are injected into the page translation prompt.
        </div>
        ...
        <Field label="Max output" layout="row" labelClassName={ui.label}>
          <input
            ...
            onChange={(e) => onUpdatePageTranslationDraft('max_output_tokens', e.target.value)}
          />
        </Field>
        <div className={`${ui.trainingHelp} ml-28`}>
        ...
        <Field label="Temperature" layout="row" labelClassName={ui.label}>
          <input
            ...
            onChange={(e) => onUpdatePageTranslationDraft('temperature', e.target.value)}
          />
        </Field>
        <div className={`${ui.trainingHelp} ml-28`}>
