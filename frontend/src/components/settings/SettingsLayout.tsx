        ...
        <section className={ui.trainingSection}>
          <div className={ui.trainingSectionHeader}>
            <div>
              ...
              <div className={ui.trainingSectionMeta}>Persisted in the database</div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <Button type="button" variant="ghostSmall" onClick={handleRefresh} disabled={loading}>
                Refresh
              </Button>
              <Button
                type="button"
          ...
          {saveMessage && <div className={ui.trainingMetaSmall}>{saveMessage}</div>}
          {!autoSaveEnabled && (
            <div className={ui.trainingMetaSmall}>
              Auto-save disabled. Use “Save changes” to persist edits.
            </div>
          )}
          {baseAutoSaving && <div className={ui.trainingMetaSmall}>Saving base settings…</div>}
          {pageTranslationAutoSaving && (
            <div className={ui.trainingMetaSmall}>Saving page translation settings…</div>
          )}
          {ocrAutoSaving && <div className={ui.trainingMetaSmall}>Saving OCR settings…</div>}
          {translationAutoSaving && (
            <div className={ui.trainingMetaSmall}>Saving translation profile settings…</div>
          )}
            ...
            {activeTab === 'llm' && (
              <>
                ...
                <PageTranslationCard
                  ...
                  pageTranslationSelectedCapability={pageTranslationSelectedCapability}
