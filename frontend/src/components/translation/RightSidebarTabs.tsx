...
import type { BoxDetectionProfile, OcrProvider, TranslationProvider, Volume } from '../../types';
  ...
  const tabButton = (tab: SidebarTab, label: string) => {
    ...
    return (
      <button
        ...
        className={`${ui.tabButtonBase} ${isActive ? ui.tabButtonActive : ui.tabButtonInactive}`}
      >
        {label}
      </button>
    );
          ...
          <div className="h-full overflow-y-auto space-y-2">
            ...
            {pageDataCollapsed && (
              <div className="flex-1 overflow-hidden">
                <PageDataPanel
                  {...pageDataProps}
                  onToggleCollapse={() => onTogglePageDataCollapsed(false)}
                  toggleLabel="Expand"
                />
              </div>
            )}
        ...
        {activeTab === 'tools' && (
          <div className="h-full overflow-y-auto">
            ...
            <RightSidebarActionsSection
              ...
              onOcrPage={onOcrPage}
              onPageTranslationWorkflow={onPageTranslationWorkflow}
