...
interface PageBoxCardProps {
  ...
  onUpdateText: (id: number, field: 'text' | 'translation', value: string) => void;
    ...
    <li className={ui.card}>
      ...
      <div className={ui.cardHeader}>
        <div className="flex items-center gap-2">
          <span className={ui.cardIndex}>#{displayOrder}</span>

          <button
            type="button"
            className={canMoveUp ? ui.button.miniMoveEnabled : ui.button.miniMoveDisabled}
          ...
          <button
            type="button"
            className={canMoveDown ? ui.button.miniMoveEnabled : ui.button.miniMoveDisabled}
        ...
        <div className="flex items-center gap-2">
          <button type="button" className={ui.button.miniAmber} onClick={() => onOcrBox(box.id)}>
            OCR
          </button>
          <button
            type="button"
          ...
          <button type="button" className={ui.button.miniRed} onClick={() => onDelete(box.id)}>
            Del
          </button>
        </div>
      </div>
