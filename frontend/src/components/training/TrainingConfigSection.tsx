            ...
            {selectedDatasetId && (
                <div className={`mt-3 ${ui.trainingList}`}>
                    <div className="flex items-center justify-between">
                        <span>Dataset</span>
                        <span className={ui.trainingMetaSmall}>
                            {selectedDatasetId}
                        </span>
                    </div>
                    <label className="block">
                        ...
                        <select
                            value={modelFamily}
                            onChange={(event) =>
                                onChangeModelFamily(event.target.value)
                            }
                    ...
                    <label className="block">
                        ...
                        <select
                            value={modelSize}
                            onChange={(event) =>
                                onChangeModelSize(event.target.value)
                            }
                            className={ui.trainingInput}
                        >
                    ...
                    <label className={`flex items-center gap-2 ${ui.trainingMetaSmall}`}>
                        <input
                            ...
                            checked={pretrained}
                            onChange={(event) =>
                                onChangePretrained(event.target.checked)
                            }
                        />
                    ...
                    <label className="block">
                        ...
                        <input
                            ...
                            value={epochs}
                            onChange={(event) =>
                                onChangeEpochs(event.target.value)
                            }
                            className={ui.trainingInput}
                        />
                    </label>
                    <label className="block">
                        ...
                        <input
                            ...
                            value={batchSize}
                            onChange={(event) =>
                                onChangeBatchSize(event.target.value)
                            }
                            className={ui.trainingInput}
                        />
                    </label>
                    <label className="block">
                        ...
                        <input
                            ...
                            value={workers}
                            onChange={(event) =>
                                onChangeWorkers(event.target.value)
                            }
                            className={ui.trainingInput}
                        />
                    </label>
                    <label className="block">
                        ...
                        <div className="mt-1 flex flex-wrap gap-2">
                            {[640, 768, 1024, 1280].map((preset) => (
                                <button
                                    ...
                                    type="button"
                                    onClick={() =>
                                        onChangeImageSize(String(preset))
                                    }
                        ...
                        <input
                            ...
                            value={imageSize}
                            onChange={(event) =>
                                onChangeImageSize(event.target.value)
                            }
                            className={ui.trainingInput}
                        />
                    </label>
                    ...
                    <label className="block">
                        ...
                        <input
                            ...
                            value={patience}
                            onChange={(event) =>
                                onChangePatience(event.target.value)
                            }
                            className={ui.trainingInput}
                        />
                    </label>
                    <label className={`flex items-center gap-2 ${ui.trainingMetaSmall}`}>
                        <input
                            ...
                            onChange={(event) =>
                                onChangeAugmentations(event.target.checked)
                            }
                        />
                    ...
                    <label className={`flex items-center gap-2 ${ui.trainingMetaSmall}`}>
                        <input
                            ...
                            checked={dryRun}
                            onChange={(event) =>
                                onChangeDryRun(event.target.checked)
                            }
                        />
                        Dry run (1 epoch, no files saved)
                    </label>
                    {trainError && (
                        <div className={ui.trainingError}>{trainError}</div>
                    )}
                    {trainJobId && (
                        <div className={ui.trainingMeta}>
                            Training queued. Track progress in Jobs.
                        </div>
                    )}
                    <button
                        type="button"
