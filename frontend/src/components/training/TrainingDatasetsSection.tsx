...
export function TrainingDatasetsSection({
    ...
    return (
        <section className={ui.trainingSection}>
            ...
            {datasetsError && (
                <div className={ui.trainingError}>{datasetsError}</div>
            )}
            ...
            {!datasetsLoading && datasets.length > 0 && (
                <div className={ui.trainingList}>
                    {datasets.map((dataset) => {
                        ...
                        const trainImages =
                            stats?.train_images === null ||
                            stats?.train_images === undefined
                                ? "n/a"
                                : stats.train_images;
                        const valImages =
                            stats?.val_images === null ||
                            stats?.val_images === undefined
                                ? "n/a"
                                : stats.val_images;
                        const testImages =
                            stats?.test_images === null ||
                            stats?.test_images === undefined
                                ? 0
                                : stats.test_images;
                        const targets = dataset.targets ?? [];
                        const splits: string[] = [];
                        if (
                            dataset.val_split !== null &&
                            dataset.val_split !== undefined
                        ) {
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center justify-between">
                                        ...
                                        {dataset.created_at && (
                                            <span className={ui.trainingLabelTiny}>
                                                {dataset.created_at}
                                            </span>
                                        )}
                                    </div>
