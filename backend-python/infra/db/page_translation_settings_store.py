# backend-python/infra/db/page_translation_settings_store.py
"""Persistence helpers for page-translation settings."""
...
def upsert_page_translation_settings(values: dict[str, Any]) -> None:
