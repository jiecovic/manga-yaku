# backend-python/tests/infra/jobs/test_db_agent_worker.py
"""Unit tests for the persisted agent workflow worker."""
...
import pytest
from infra.jobs import db_agent_worker
...
async def test_run_claimed_workflow_executes_agent_handler_with_persisted_ids() -> None:
    ...
    with (
        ...
        patch.object(db_agent_worker, "get_workflow_run", return_value=run_record),
        ...
        await db_agent_worker._run_claimed_workflow(
            claimed,
            log_store={},
